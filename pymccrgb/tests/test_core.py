...
from pymccrgb import core, ioutils
...
class MCCTestCase(unittest.TestCase):
    ...
    def _test_classify_ground_mcc(self, scale, tol):
        test = core.classify_ground(self.data, scale, tol)
    ...
    def test_mcc_default(self):
        test_points, test_labels = core.mcc(self.data, verbose=True)
...
class MCCRGBTestCase(unittest.TestCase):
    ...
    def test_mcc_rgb_default(self):
        test_points, test_labels = core.mcc_rgb(self.data, verbose=True)
